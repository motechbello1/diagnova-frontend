...
const AboutPage: React.FC = () => (
  <Container maxWidth="lg">
    <Box sx={{ py: 6 }}>
      <Typography variant="h4" gutterBottom sx={{fontWeight:700}}>About DiagNova</Typography>
      <Grid container spacing={3} sx={{ mt: 2 }}>
        <Grid size={{xs:12, md:6}}>
          <Card sx={{ height: '100%' }}>
            <CardContent sx={{ p: 3 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 2 }}><SchoolIcon sx={{ color: '#6C63FF' }} /><Typography variant="h6" sx={{fontWeight:600}}>Research Project</Typography></Box>
        ...
        <Grid size={{xs:12, md:6}}>
          <Card sx={{ height: '100%' }}>
            <CardContent sx={{ p: 3 }}>
              <Typography variant="h6" gutterBottom sx={{fontWeight:600}}>Technical Stack</Typography>
